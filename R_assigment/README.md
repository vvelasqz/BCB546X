#This repository contains all the files of the R assigment. They include the R notebook in Rmd format with all the instructions and .nb formamt which has all the instructions and plots, and the output files.
